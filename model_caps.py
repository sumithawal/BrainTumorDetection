...
path1 = 'E:/Brain Tumor Detection with Level new/dataset/4'    #path of folder of images    
path2 = 'E:/Brain Tumor Detection with Level new/input_data_resized/4'  #path of folder to save images    
