...
root.title("Brain Tumar Detection System")


#430
#++++++++++++++++++++++++++++++++++++++++++++
#####For background Image
image2 =Image.open('brain1.jpg')
...
#
lbl = tk.Label(root, text="Brain Tumar Detection System", font=('times', 35,' bold '), height=1, width=32,bg="Gold",fg="white")
...
#    global fn
    ...
    if fn!="":
        ...
        model = load_model('caps_network.h5')
...
#
button4 = tk.Button(frame_alpr, text="Capsule Prediction", command=test_model,width=20, height=1,bg="white",fg="black", font=('times', 15, ' bold '))
